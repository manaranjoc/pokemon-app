...
const Navbar = () => {
  ...
  return (
    <nav className={styles.navbar}>
      ...
      <div>
        <Route path='/' exact>
          <input ref={inputFilterPokemons} type='text' placeholder='Search' className={styles.searchbar}
                 onChange={filterPokemonsInput}/>
        </Route>
        <Route path='/items'>
          <input ref={inputFilterItems} type='text' placeholder='Search' className={styles.searchbar}
                 onChange={filterItemsInput}/>
        </Route>
      </div>
    </nav>
  )
